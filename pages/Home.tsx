...
import { SHOP_INFO, TESTIMONIALS, MARKETPLACE_PARTNERS } from '../constants';
import FeaturedBanners from '../components/FeaturedBanners';
import OrderViaButtons from '../components/OrderViaButtons';
      ...
      <section className="relative bg-secondary text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-orange-300 font-semibold mb-4">
              {heroCopy.subheadline}
            </p>
            <p className="text-base text-gray-300 mb-2">
              {heroCopy.materialLine}
            </p>
            <p className="text-sm text-primary font-bold mb-4">
              {heroCopy.microCopy}
            </p>
            <p className="text-lg md:text-xl text-white font-medium mb-8 italic">
              "{heroCopy.tagline}"
            </p>
